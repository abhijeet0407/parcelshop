            ...
            <section id="content">
                ...
                <div class="card">
                        ...
                        <div class="action-header palette-Teal-400 bg clearfix">
                            <div class="ah-label hidden-xs palette-White text">Shopmanagers</div>
                            ...
                            <ul class="ah-actions actions a-alt">
                                ...
                                <li>
                                    <a class="alt_menu <?php echo $bgcolor; ?>" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Add New" href="<?php echo url('shopmanager/create'); ?>" >
                                        <i class="zmdi zmdi-plus-circle"></i>
                                    </a>
                                </li>
                                
                                <li>
                                      <a class="alt_menu <?php echo $bgcolor; ?>" data-table="shopmanager" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Bulk delete" href="javascript:void(0)"><i class="zmdi zmdi-minus-circle"></i></a>
                                </li>
                                <li>
                        ...
                        <div class="list-group lg-alt lg-even-black">
                            <?php if(count($shopmanager_data)==0){ ?>
                            ...
                            <?php foreach($shopmanager_data as $shopmanager){ ?>

                            <div rel="<?php echo $shopmanager->id; ?>" class="list-group-item media">
                                <div class="pull-right">
                                            ...
                                            <a href="javascript:void(0)" rel="<?php echo $shopmanager->id; ?>" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Remove" data-table="shopmanager" class="btn singleDelete btn-xs btn-danger m-l-10 btn-icon waves-effect waves-circle waves-float"><i class="zmdi zmdi-delete"></i></a>
                                ...
                                <div class="pull-left">
                                	<div data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Check this box to add this listing to bulk delete" class="avatar-char ac-check">
                                                <input class="acc-check" value="<?php echo $shopmanager->id; ?>" type="checkbox">

                                                <span class="acc-helper palette-Teal bg"><?php echo substr($shopmanager->name,0,1) ?></span>
                                            </div>
                                    
                                </div>

                                <div class="media-body">
                                    <div class="lgi-heading"><?php echo $shopmanager->name; ?></div>
                                    <small class="lgi-text"><?php echo $shopmanager->shopmanager->address ?></small>
                                    <ul class="lgi-attrs">
                                        <li><?php echo $shopmanager->email; ?></li>
                                        <li><?php echo $shopmanager->shopmanager->phone; ?></li> 
                        ...
                        <div class="text-center"><?php echo $shopmanager_data->links(); ?></div>
                    </div>
                <!-- card containers -->
